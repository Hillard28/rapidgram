...
double cratio(std::string string1, std::string string2, bool strict) {
...
double cpartial_ratio(std::string string1, std::string string2, bool strict) {
